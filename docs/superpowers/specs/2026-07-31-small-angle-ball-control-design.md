...
- Rod angle limit: +/-16.0 degrees for fast edge recovery.
...
- The software watchdog remains active and must use a valid, reusable CanMV
  Timer lifecycle.
- Estimated rod angle is always clamped to +/-16.0 degrees.
...
field represents estimated rod angle and must remain within +/-16.0 degrees. No
...
- Target angle is clamped to +/-16.0 degrees.
- A large ball error cannot command more than +/-16.0 degrees.
...
3. Confirm the rod never exceeds +/-16.0 degrees.
